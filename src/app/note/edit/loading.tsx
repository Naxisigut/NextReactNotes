    ...
    <div className="note-editor skeleton-container" role='progressbar' aria-busy='true'>
      ...
      <div className="note-editor-preview">
        <div className="note-editor-menu">
          ...
          <div className="skeleton skeleton--button" style={{ width: '8em', height: '2.5em', marginInline: '12px 0' }}></div>
        </div>
        <div className="note-title skeleton" style={{ height: '3rem', width: '65%', marginInline: '12px 1em' }}></div>
